...
def build_receipt(*, status: str, dry_run: bool, backend: str, host_model: str, image_model: str, quality: str, aspect: str, size: str, out: Path, prompt: str, refs: list[Path], include_prompt: bool = False, error_class: str | None = None) -> dict[str, Any]:
